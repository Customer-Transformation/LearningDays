...
function _page($$payload, $$props) {
  ...
  $$payload.out.push(`<!----></div> <div class="rooms svelte-1bt7yps"><h2 class="svelte-1bt7yps">Room sharing</h2> <p class="svelte-1bt7yps">Here you can find more information about your stay at Skogshem &amp; Wijk. If your name does not appear, you have your own room</p> `);
